...
void CFilterDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_EDIT_SIGMA2, m_EditSigma2);
	DDX_Control(pDX, IDC_SPIN_SIGMA2, m_SpinSigma2);
	DDX_Control(pDX, IDC_EDIT_KSIZE2, m_EditKSize2);
	DDX_Control(pDX, IDC_SPIN_KSIZE2, m_SpinKSize2);
}
...
BEGIN_MESSAGE_MAP(CFilterDlg, CDialogEx)
	...
	ON_NOTIFY(UDN_DELTAPOS, IDC_SPIN_SIGMA2, &CFilterDlg::OnDeltaposSpinSigma2)
	ON_NOTIFY(UDN_DELTAPOS, IDC_SPIN_KSIZE2, &CFilterDlg::OnDeltaposSpinKsize2)
END_MESSAGE_MAP()
...
void CFilterDlg::OnDeltaposSpinKsize2(NMHDR* pNMHDR, LRESULT* pResult)
{
	LPNMUPDOWN pNMUpDown = reinterpret_cast<LPNMUPDOWN>(pNMHDR);
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	int ival = pNMUpDown->iPos + pNMUpDown->iDelta;
...
void CFilterDlg::OnDeltaposSpinSigma2(NMHDR* pNMHDR, LRESULT* pResult)
{
	LPNMUPDOWN pNMUpDown = reinterpret_cast<LPNMUPDOWN>(pNMHDR);
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
